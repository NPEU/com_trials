...
namespace NPEU\Component\Trials\Administrator\Model;
 ...
 * Trial Model
 */
class TrialModel extends AdminModel
{
    /**
     ...
     */
    /*public function getTable($type = 'Trials', $prefix = 'TrialsTable', $config = array())
    {
    ...
    public function save($data)
    {
        ...
        if (in_array($input->get('task'), ['apply', 'save', 'save2new'])) {
            if (empty($data['alias'])) {
                ...
                $table = $this->getMVCFactory()->createTable('Trial', 'Administrator');
     ...
     * @return  array  Contains the modified title and alias.
     */
    /*protected function generateNewTrialsTitle($alias, $title)
    {
        // Alter the title & alias
        $table = $this->getTable();
    ...
    {
        #return 'administrator/components/com_trials/models/forms/trials.js';
        return '';
    }*/
    ...
    /*private function _sendEmail($email_data)
    {
            ...
            $mail->setSubject(Text::_('COM_TRIALS_EMAIL_ADMINS_SUBJECT'));
            $mail->setBody(Text::_('COM_TRIALS_EMAIL_ADMINS_BODY'));
            $sent = $mail->Send();
