 ...
 * Trials List Model
 */
class TrialsModel extends ListModel
{
    /**
     * Constructor.
     *
    ...
    protected function populateState($ordering = 'a.title', $direction = 'ASC')
    {
        ...
        // Load the parameters.
        $params = ComponentHelper::getParams('com_trials');
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                'list.select',
                'a.id, a.title, a.alias, a.web_landing_include, a.catid, a.owner_user_id, a.checked_out, a.checked_out_time, a.created, a.created_by, a.state'
            )
        );
        $query->from($db->quoteName('#__trials', 'a'));
