...
namespace NPEU\Component\Trials\Site\View\Trial;
...
class HtmlView extends BaseHtmlView {
    ...
    public function display($template = null)
    {
        ...
        */
        ...
        if ($is_new) {
            $breadcrumb_title  = Text::_('COM_TRIALS_PAGE_TITLE_ADD_NEW');
        } else {
        ...
        $document->page_title = $this->item->title;
        ...
        // 'index.php?option=com_trials&view=trials&Itemid=xxx' )
        ...
        */
        ...
        if ((!$breadcrumb_title = $item->title) && $is_new) {
            $breadcrumb_title  = JText::_('COM_TRIALS_PAGE_TITLE_ADD_NEW');
        }
